...
@section('content')
    <!--Header part-->
    <header>
        <img src="{{ asset('Images/Headers/header bg main.png') }}" alt="Header Image">
    </header>
    ...
    <div class="img_menu_cont">
        <section class="image-links">
            ...
            <a href="{{ route('drinks') }}" class="image-link">
                <img src="{{ asset('Images/Logos/drinks_logo.png') }}" alt="Drinks">
            </a>
        </section>
    </div>
    ...
    <div class="rec_heading_cont">
        ...
        <div class="heading_rec">
            <h1 id="rec_title">Avanti<br>Main Courses</h1>
        </div> 
    </div>
